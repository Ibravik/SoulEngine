...
#define PLATFORM_TCHAR_IS_1_BYTE 0			//Indicamos que los caracteres en esta plataforma son de más de 1 byte
	...
	typedef std::wstring soString;				//Definimos el tipo soString
...
#define PLATFORM_TCHAR_IS_1_BYTE 1			//Indicamos que los caracteres en esta plataforma son de 1 byte
	...
	typedef std::string soString;				//Definimos el tipo soString
#endif	// UNICODE
#define ARRAYSIZE(_ARR)  ((int)(sizeof(_ARR)/sizeof(*_ARR))) // Retorna el tamaño de un arreglo

	/************************************************************************************************************************/
	/* Constantes de FileStream                                                												*/
	/************************************************************************************************************************/
#ifdef UNICODE		//Si estamos utilizando UNICODE
#define PLATFORM_TCHAR_IS_1_BYTE 0			//Indicamos que los caracteres en esta plataforma son de más de 1 byte
	typedef std::wfstream soFile;			//Definimos el tipo soFile
#else	//Estamos compilando en Multi-byte
#define PLATFORM_TCHAR_IS_1_BYTE 1			//Indicamos que los caracteres en esta plataforma son de 1 byte
	typedef std::fstream soFile;			//Definimos el tipo soString
#endif	// UNICODE
