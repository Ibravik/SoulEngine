...
namespace SoulSDK
{
	...
	/************************************************************************/
	class soSceneNode : public soNode
	{
		/************************************************************************/
		/* Declaracion de contructores y destructor                             */
		/************************************************************************/
	public:
		soSceneNode();									/*!< Constructor Standard */
		virtual ~soSceneNode();						/*!< Destructor */
	...
	public:
		...
		soSceneNode* m_Parent;							/*!< Referencia al nodo al que estoy emparentados */
		
		/************************************************************************/
		/* Declaracion de funciones de ayuda de la clase                        */
		/************************************************************************/
	private:		
		void RemoveChild(soSceneNode* _Child);			/*!< Remueve un nodo hijo de la lista */
	...
	public:		
		...
		void AddChild(soSceneNode* _Child);			/*!< Ingresa un nuevo nodo hijo */	
		void SetParent(soSceneNode* _Parent);			/*!< Asigna un padre al nodo */
