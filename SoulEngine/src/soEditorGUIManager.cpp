...
/**
* @LC	  11/23/2016
* @file   soEditorGUIManager.cpp
* @Author Aldo Muñoz (lehi.munoz@gmail.com)
* @date   11/23/2016
* @brief  Implementacion de la clase soEditorGUIManager
* @bug	   No known bugs.
*/
/********************************************************************/
...
namespace SoulSDK
{
	soEditorGUIManager::soEditorGUIManager()
	{
		Connect(std::bind(&soEditorGUIManager::OnStartUp, this, std::placeholders::_1));
	...
	{
		soEditorGUIManager* _GUI = soEditorGUIManager::InstancePtr();
	...
	RESULT soEditorGUIManager::OnStartUp(const EditorGUIData& _EditorGUIData)
	{
	...
	void soEditorGUIManager::OnShutDown()
	{
	}

	void soEditorGUIManager::CreateFontsTexture()
	{
	...
	void soEditorGUIManager::Update()
	{
		ImGuiIO& io = ImGui::GetIO();
	...
	void soEditorGUIManager::Render()
	{
		soDXGIManager& AppiManager = soDXGIManager::Instance();
	...
	LRESULT soEditorGUIManager::InputHandler(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
	{
		(void)hWnd;
		ImGuiIO& io = ImGui::GetIO();
		switch (msg)
