...
/**
* @LC	  11/23/2016
* @file   soEditorGUIManager.h
* @Author Aldo Muñoz (lehi.munoz@gmail.com)
* @date   11/23/2016
* @brief  Declaration of class soEditorGUIManager. Esta clase gestiona la 
...
namespace SoulSDK
{
	...
	/************************************************************************/
	class soEditorGUIManager : public soModule<soEditorGUIManager, const EditorGUIData&>
	{
		/************************************************************************/
		/* Declaracion de contructores y destructor                             */
		/************************************************************************/
	public:
		soEditorGUIManager();																/*!< Constructor Standard */
		~soEditorGUIManager();																/*!< Destructor */
	...
	public:
		...
		/************************************************************************/
	private:
		RESULT OnStartUp(const EditorGUIData& _EditorGUIData);								/*!< Inicializacion */
